...
function finalizarPedido() {
    ...
    // Monta lista de itens ANTES de qualquer async/timeout
    // Safari iOS bloqueia window.open() fora do contexto síncrono do clique do usuário
    var totalGeral = 0;
    var listaItens = "";
    ...
    // Feedback visual após o redirecionamento já ter sido iniciado
